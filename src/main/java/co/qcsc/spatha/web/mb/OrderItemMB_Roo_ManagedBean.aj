...
privileged aspect OrderItemMB_Roo_ManagedBean {
    ...
    public HtmlPanelGrid OrderItemMB.populateCreatePanel() {
        ...
        OutputLabel tagNumberCreateOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        tagNumberCreateOutput.setFor("tagNumberCreateInput");
        tagNumberCreateOutput.setId("tagNumberCreateOutput");
        tagNumberCreateOutput.setValue("Tag Number:");
        htmlPanelGrid.getChildren().add(tagNumberCreateOutput);
        
        InputText tagNumberCreateInput = (InputText) application.createComponent(InputText.COMPONENT_TYPE);
        tagNumberCreateInput.setId("tagNumberCreateInput");
        tagNumberCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{orderItemMB.orderItem.tagNumber}", String.class));
        tagNumberCreateInput.setRequired(false);
        htmlPanelGrid.getChildren().add(tagNumberCreateInput);
        
        Message tagNumberCreateInputMessage = (Message) application.createComponent(Message.COMPONENT_TYPE);
        tagNumberCreateInputMessage.setId("tagNumberCreateInputMessage");
        tagNumberCreateInputMessage.setFor("tagNumberCreateInput");
        tagNumberCreateInputMessage.setDisplay("icon");
        htmlPanelGrid.getChildren().add(tagNumberCreateInputMessage);
        
        OutputLabel serialCreateOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        serialCreateOutput.setFor("serialCreateInput");
        serialCreateOutput.setId("serialCreateOutput");
        serialCreateOutput.setValue("Serial:");
        htmlPanelGrid.getChildren().add(serialCreateOutput);
        
        InputText serialCreateInput = (InputText) application.createComponent(InputText.COMPONENT_TYPE);
        serialCreateInput.setId("serialCreateInput");
        serialCreateInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{orderItemMB.orderItem.serial}", String.class));
        serialCreateInput.setRequired(false);
        htmlPanelGrid.getChildren().add(serialCreateInput);
        
        Message serialCreateInputMessage = (Message) application.createComponent(Message.COMPONENT_TYPE);
        serialCreateInputMessage.setId("serialCreateInputMessage");
        serialCreateInputMessage.setFor("serialCreateInput");
        serialCreateInputMessage.setDisplay("icon");
        htmlPanelGrid.getChildren().add(serialCreateInputMessage);
    ...
    public HtmlPanelGrid OrderItemMB.populateEditPanel() {
        ...
        OutputLabel tagNumberEditOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        tagNumberEditOutput.setFor("tagNumberEditInput");
        tagNumberEditOutput.setId("tagNumberEditOutput");
        tagNumberEditOutput.setValue("Tag Number:");
        htmlPanelGrid.getChildren().add(tagNumberEditOutput);
        
        InputText tagNumberEditInput = (InputText) application.createComponent(InputText.COMPONENT_TYPE);
        tagNumberEditInput.setId("tagNumberEditInput");
        tagNumberEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{orderItemMB.orderItem.tagNumber}", String.class));
        tagNumberEditInput.setRequired(false);
        htmlPanelGrid.getChildren().add(tagNumberEditInput);
        
        Message tagNumberEditInputMessage = (Message) application.createComponent(Message.COMPONENT_TYPE);
        tagNumberEditInputMessage.setId("tagNumberEditInputMessage");
        tagNumberEditInputMessage.setFor("tagNumberEditInput");
        tagNumberEditInputMessage.setDisplay("icon");
        htmlPanelGrid.getChildren().add(tagNumberEditInputMessage);
        
        OutputLabel serialEditOutput = (OutputLabel) application.createComponent(OutputLabel.COMPONENT_TYPE);
        serialEditOutput.setFor("serialEditInput");
        serialEditOutput.setId("serialEditOutput");
        serialEditOutput.setValue("Serial:");
        htmlPanelGrid.getChildren().add(serialEditOutput);
        
        InputText serialEditInput = (InputText) application.createComponent(InputText.COMPONENT_TYPE);
        serialEditInput.setId("serialEditInput");
        serialEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{orderItemMB.orderItem.serial}", String.class));
        serialEditInput.setRequired(false);
        htmlPanelGrid.getChildren().add(serialEditInput);
        
        Message serialEditInputMessage = (Message) application.createComponent(Message.COMPONENT_TYPE);
        serialEditInputMessage.setId("serialEditInputMessage");
        serialEditInputMessage.setFor("serialEditInput");
        serialEditInputMessage.setDisplay("icon");
        htmlPanelGrid.getChildren().add(serialEditInputMessage);
    ...
    public HtmlPanelGrid OrderItemMB.populateViewPanel() {
        ...
        HtmlOutputText tagNumberLabel = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
        tagNumberLabel.setId("tagNumberLabel");
        tagNumberLabel.setValue("Tag Number:");
        htmlPanelGrid.getChildren().add(tagNumberLabel);
        
        HtmlOutputText tagNumberValue = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
        tagNumberValue.setId("tagNumberValue");
        tagNumberValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{orderItemMB.orderItem.tagNumber}", String.class));
        htmlPanelGrid.getChildren().add(tagNumberValue);
        
        HtmlOutputText serialLabel = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
        serialLabel.setId("serialLabel");
        serialLabel.setValue("Serial:");
        htmlPanelGrid.getChildren().add(serialLabel);
        
        HtmlOutputText serialValue = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
        serialValue.setId("serialValue");
        serialValue.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{orderItemMB.orderItem.serial}", String.class));
        htmlPanelGrid.getChildren().add(serialValue);
