...
privileged aspect DossierMB_Roo_ManagedBean {
    ...
    public HtmlPanelGrid DossierMB.populateCreatePanel() {
        ...
        orderItemCreateInput.setValueExpression("itemLabel", expressionFactory.createValueExpression(elContext, "#{orderItem.quantity} #{orderItem.tagNumber} #{orderItem.serial}", String.class));
    ...
    public HtmlPanelGrid DossierMB.populateEditPanel() {
        ...
        orderItemEditInput.setValueExpression("itemLabel", expressionFactory.createValueExpression(elContext, "#{orderItem.quantity} #{orderItem.tagNumber} #{orderItem.serial}", String.class));
    ...
    public List<OrderItem> DossierMB.completeOrderItem(String query) {
        ...
        for (OrderItem orderItem : orderItemService.findAllOrderItems()) {
            String orderItemStr = String.valueOf(orderItem.getQuantity() +  " "  + orderItem.getTagNumber() +  " "  + orderItem.getSerial());
