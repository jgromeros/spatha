...
public class PurchaseOrderMB {
	...
	public HtmlPanelGrid populateViewPanel() {
		...
		HtmlOutputText numberOrderLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText numberOrderValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		numberOrderValue.setId("numberOrderValue");
		numberOrderValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.numberOrder}",
						String.class));
		htmlPanelGrid.getChildren().add(numberOrderValue);

		HtmlOutputText supplierContactLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText supplierContactValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		supplierContactValue.setId("supplierContactValue");
		supplierContactValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.supplierContact}",
						String.class));
		htmlPanelGrid.getChildren().add(supplierContactValue);

		HtmlOutputText clientContactLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText clientContactValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		clientContactValue.setId("clientContactValue");
		clientContactValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.clientContact}",
						String.class));
		htmlPanelGrid.getChildren().add(clientContactValue);

		HtmlOutputText supplierPhoneLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText supplierPhoneValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		supplierPhoneValue.setId("supplierPhoneValue");
		supplierPhoneValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.supplierPhone}",
						String.class));
		htmlPanelGrid.getChildren().add(supplierPhoneValue);

		HtmlOutputText clientPhoneLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText clientPhoneValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		clientPhoneValue.setId("clientPhoneValue");
		clientPhoneValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.clientPhone}",
						String.class));
		htmlPanelGrid.getChildren().add(clientPhoneValue);

		HtmlOutputText supplierEmailLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText supplierEmailValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		supplierEmailValue.setId("supplierEmailValue");
		supplierEmailValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.supplierEmail}",
						String.class));
		htmlPanelGrid.getChildren().add(supplierEmailValue);

		HtmlOutputText clientEmailLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		...
		HtmlOutputText clientEmailValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		clientEmailValue.setId("clientEmailValue");
		clientEmailValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.clientEmail}",
						String.class));
		htmlPanelGrid.getChildren().add(clientEmailValue);

		HtmlOutputText clientLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		clientLabel.setId("clientLabel");
		clientLabel.setValue("Client:");
		htmlPanelGrid.getChildren().add(clientLabel);

		HtmlOutputText clientValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		clientValue.setValueExpression("value",
				expressionFactory
						.createValueExpression(elContext,
								"#{purchaseOrderMB.purchaseOrder.client}",
								Client.class));
		...
		HtmlOutputText supplierLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		supplierLabel.setId("supplierLabel");
		supplierLabel.setValue("Supplier:");
		htmlPanelGrid.getChildren().add(supplierLabel);

		HtmlOutputText supplierValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		supplierValue.setValueExpression("value", expressionFactory
				.createValueExpression(elContext,
						"#{purchaseOrderMB.purchaseOrder.supplier}",
						Supplier.class));
		...
		HtmlOutputText itemsLabel = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		itemsLabel.setId("itemsLabel");
		itemsLabel.setValue("Items:");
		htmlPanelGrid.getChildren().add(itemsLabel);

		HtmlOutputText itemsValue = (HtmlOutputText) application
				.createComponent(HtmlOutputText.COMPONENT_TYPE);
		itemsValue
				.setValueExpression("value", expressionFactory
						.createValueExpression(elContext,
								"#{purchaseOrderMB.purchaseOrder.items}",
								String.class));
	...
	public String findAllPurchaseOrders() {
